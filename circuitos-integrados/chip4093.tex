...
\section{Chip 4093} \label{sec:chip4093}
...
\begin{enumerate}
    \item 01 a $V_{CC}$ o a un secuenciador que controle compuerta 1
    \item 05 a $V_{CC}$ o a un secuenciador que controle compuerta 2
    \item 08 a $V_{CC}$ o a un secuenciador que controle compuerta 3
    \item 12 a $V_{CC}$ o a un secuenciador que controle compuerta 4
\end{enumerate}

\subsubsection{Salidas}

\begin{enumerate}
    \item 03 es la salida de la compuerta 1
    \item 04 es la salida de la compuerta 2
    \item 10 es la salida de la compuerta 3
    \item 11 es la salida de la compuerta 4
\end{enumerate}
...
\begin{enumerate}
    \item 02 conectada a tierra a través de un capacitor de 1 $\mu F$
    \item 06 conectada a tierra a través de un capacitor de 1 $\mu F$
    \item 09 conectada a tierra a través de un capacitor de 1 $\mu F$
    \item 13 conectada a tierra a través de un capacitor de 1 $\mu F$
    \item 02 conectada a 03 a través de un potenciómetro de 100 k$\Omega$
    \item 06 conectada a 04 a través de un potenciómetro de 100 k$\Omega$
    \item 09 conectada a 10 a través de un potenciómetro de 100 k$\Omega$
    \item 13 conectada a 11 a través de un potenciómetro de 100 k$\Omega$
\end{enumerate}
